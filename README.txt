...
The second part of the project is not related to dogs and just provides various functions that can be created using the C++ algorithms.
...
The purpose of the program is to use the following in C++:
